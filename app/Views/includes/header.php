...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="<?= site_url(); ?>inicio"><img src="<?= site_url(); ?>public/img/cashier-logo.png" alt="logo" id="img-logo"></a>
            <!-- Sidebar Toggle-->
            ...
            <ul class="navbar-nav ms-auto  mr-md-3 my-2 my-md-0">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                        <!--<li><a class="dropdown-item" href="#!">Editar datos usuario</a></li>
                        <li><a class="dropdown-item" href="#!">Reporte de actividad mensual</a></li> -->
