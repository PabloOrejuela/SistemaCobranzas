    ...
    <div class="col-sm-8 mb-5">
        ...
        <form action="<?php echo base_url().'/recibe_nuevo_usuario';?>" method="post">
            ...
            <div class="mb-1 row">
                ...
                <div class="col-sm-6">
                    <input type="text" class="form-control" name="telefono" placeholder="0991111234">
            ...
            <div class="mb-1 row">
                ...
                <div class="col-sm-6">
                    <input type="text" class="form-control" name="direccion" placeholder="22 Acacia Ave., Rue de L' Morgue">
                    <p id="error-message"><?= session('errors.telefono');?> </p>
                </div>
            </div>
            <div class="mb-1 row">
