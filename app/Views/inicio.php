...
<header>
    ...
    <div class="menu">
        <ul>
            ...
            <li class="menu-item hidden"><a href="#" target="_self">Docs</a>
            </li>
            <li class="menu-item hidden"><a href="#" target="_self">Community</a></li>
            <li class="menu-item hidden"><a href="#" target="_self">Contribute</a>
            </li>
        </ul>
    </div>
...
<footer>
    <div class="environment">
        ...
        <p>Página renderizada en {elapsed_time} segundos</p>
